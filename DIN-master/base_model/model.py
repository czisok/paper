...
class Model(object):
  ...
  def __init__(self, user_count, item_count, cate_count, cate_list):
    ...
    item_emb_w = tf.get_variable("item_emb_w", [item_count, hidden_units // 2])                 # [I, H]
    ...
    ic = tf.gather(cate_list, self.i)                   # 找出预测iid所对应的类别,[B]
    i_emb = tf.concat(values = [                        # iid和cate对应的嵌入向量concat来表示一个item,[B, H]
