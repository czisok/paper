...
class Model(object):
    def __init__(self, n_uid, n_mid, n_cat, EMBEDDING_DIM, HIDDEN_SIZE, ATTENTION_SIZE, use_negsampling = False):
        ...
        self.item_eb = tf.concat([self.mid_batch_embedded, self.cat_batch_embedded], 1)             # [B, 2H]
        self.item_his_eb = tf.concat([self.mid_his_batch_embedded, self.cat_his_batch_embedded], 2) # [B, L, 2H]
        self.item_his_eb_sum = tf.reduce_sum(self.item_his_eb, 1)                                   # [B, H]
